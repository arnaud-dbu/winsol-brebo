...
page_builder:
  -
    ...
    type: text_image
    overline: Zomer
    title: 'Zonwering eerst, airco daarna'
    text:
      -
        type: paragraph
        attrs:
        ...
        content:
          -
            type: text
            text: 'Ons land heeft meer en meer af te rekenen met periodes van extreme hitte. Een airco maakt het huis dan weer leefbaar, en wij plaatsen toestellen die geruisloos werken en optimaal renderen. We hebben ook de exclusieve aircotoestellen van Daikin in huis.'
      -
        type: paragraph
        attrs:
          textAlign: left
    ...
    features:
      -
        id: ac-h1
        type: feature
        label: 'Geruisloze toestellen'
        enabled: true
      -
        id: ac-h2
        type: feature
        label: 'Exclusieve Daikin-toestellen'
        enabled: true
      -
        id: ac-h3
        type: feature
        label: 'Advies over vermogen per ruimte'
        enabled: true
    background: false
    enabled: true
  -
    id: ac-verwarmen
    type: text_image
    overline: Tussenseizoen
    title: 'Hetzelfde toestel verwarmt ook'
    text:
      -
        type: paragraph
        attrs:
    ...
    features:
      -
        id: ac-v1
        type: feature
        label: 'Koelen en verwarmen'
        enabled: true
      -
        id: ac-v2
        type: feature
        label: 'Te koppelen aan een warmtepomp'
        enabled: true
      -
        id: ac-v3
        type: feature
        label: 'Het hele jaar bruikbaar'
        enabled: true
    background: true
    enabled: true
  -
