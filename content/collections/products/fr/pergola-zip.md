...
page_builder:
  -
    ...
    type: text_image
    overline: 'Le toit'
    title: 'Un toit incliné qui évacue la pluie'
    text:
      -
        type: paragraph
        attrs:
    ...
    features:
      -
        id: zip-f1
        type: feature
        label: 'Toile enroulable, partiellement ou entièrement'
        enabled: true
      -
        id: zip-f2
        type: feature
        label: 'Évacuation de la pluie intégrée dans les poteaux'
        enabled: true
      -
        id: zip-f3
        type: feature
  ...
  -
    ...
    technical_details:
      -
        id: zip-s1
        key: Toit
        value: 'Incliné, avec toile enroulable'
      -
        id: zip-s2
        key: 'Évacuation de la pluie'
        value: 'Intégrée dans les poteaux'
      -
        id: zip-s3
        key: Éclairage
        value: 'Six possibilités, dimmables'
      -
        id: zip-s4
        key: Commande
