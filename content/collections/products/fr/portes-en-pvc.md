...
page_builder:
  -
    ...
    type: text_image
    overline: Style
    title: 'Du panneau classique au design plat et moderne'
    text:
      -
        type: paragraph
        attrs:
        ...
        content:
          -
            type: text
            text: 'Une porte en PVC ne doit pas forcément ressembler à une porte standard. Vous choisissez parmi des panneaux en relief, des versions planes, des divisions vitrées et des films aspect bois impossibles à distinguer du vrai bois à un mètre de distance.'
      -
        type: paragraph
        attrs:
          textAlign: left
    ...
    features:
      -
        id: pvd-f1
        type: feature
        label: 'Panneaux, plans ou à division vitrée'
        enabled: true
      -
        id: pvd-f2
        type: feature
        label: 'Finition aspect bois possible'
        enabled: true
      -
        id: pvd-f3
        type: feature
        label: 'Quincaillerie anti-effraction'
        enabled: true
    background: false
    enabled: true
  -
    ...
    technical_details:
      ...
      -
        id: pvd-s5
        key: Finition
        value: 'Coloris et films aspect bois'
      -
        id: pvd-s6
        key: Entretien
